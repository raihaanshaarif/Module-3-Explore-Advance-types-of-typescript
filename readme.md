...
> (Emni as number) diye . dot dile number er sob feature available hobe.
> Similarly (emni as string) diye . dot dile string er sob features
> dekhabe.
> 
> Function e o attestation use kora jai. Param declare stype set kora
> jai also result set kora jai.
> 
> Jokhon function ke call kora jai tokhon explicitly as diye type
> declare kora jai.
...
> Angle bracket diye o type declare kora jai but ei ta tsx e kaaj korbe
> naah
...
> Type ke interface diye o lekha jai. Basic type alias use hoi primitive
> er jonne and interface use hoi object er jonne. Object List: regular
